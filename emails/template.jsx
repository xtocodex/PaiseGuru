...
export default function EmailTemplate({
      ...
      <Html>
        ...
        <Body style={styles.body}>
          <Container style={styles.container}>
            ...
            {insights.length > 0 && (
              <Section style={styles.section}>
                <Heading style={styles.heading}>Paise Guru Insights</Heading>
            ...
            <Text style={styles.footer}>
              Thank you for using Paise Guru. Keep tracking your finances for better
              financial health!
            </Text>
          </Container>
        </Body>
  ...
  return (
    <Html>
      <Head />
      <Preview>Financial Report</Preview>
      <Body style={styles.body}>
        <Container style={styles.container}>
          <Text style={styles.text}>Hello {userName},</Text>
          <Text style={styles.text}>We couldn't determine your report type.</Text>
        </Container>
      </Body>
    </Html>
  );
